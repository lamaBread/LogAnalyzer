...
export default function Code200Page() {
  ...
  const leadingPrompt = "Analyze the logs with status codes ranging from 200 to 299 and generate a security report about the server status within 100 words.";
